...
export default function DetalhesProduto({ id }) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-pink-50 via-white to-pink-100 flex flex-col items-center justify-center px-6 py-10">
      <div className="max-w-md bg-white rounded-3xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <button
            onClick={() => router.back()}
            className="bg-linear-to-r from-pink-500 to-purple-500 text-white px-6 py-2 rounded-full hover:scale-105 transition-all"
          >
            ← Voltar
          </button>
        </div>
